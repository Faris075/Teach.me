            ...
            <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        {{-- Notification Bell --}}
                        <div class="relative">
                            <a href="{{ auth()->user()->role === 'student' ? route('student.notifications') : '#' }}" class="p-2 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors relative">
