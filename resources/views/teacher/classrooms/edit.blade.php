...
<div class="max-w-lg">
    ...
    <h1 class="text-2xl font-bold text-slate-800 dark:text-white mb-6">Edit Classroom</h1>
    ...
    <form method="POST" action="{{ route('teacher.classrooms.update', $classroom) }}"
        ...
        <div>
            ...
            <input type="text" id="name" name="name" value="{{ old('name', $classroom->name) }}" autofocus
